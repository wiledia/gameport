...
<div class="container">
    <div class="row">
        <div class="col-md-3" style="width: 300px; border:1px dotted #f00;">
    ...
    <div class="row">
        <div class="col-md-3" style="width: 300px; border:1px dotted #f00; ">
            <div class="input-group">
                <span class="input-group-addon" id="basic-addon1">@</span>
                <select class="selectpicker form-control" xdata-width="100%">
                    <option>Very looooooooooooooooooooooooooooooooooooooooong option</option>
                    <option>Ketchup</option>
                    <option>Relish</option>
                </select>
            </div>
...
<div class="container">
  ...
  <form role="form">
    <div class="form-group form-group-lg row">
      ...
      <div class="col-lg-10">
        <select id="error" class="selectpicker show-tick form-control is-invalid" required>
          <option>pen</option>
  ...
  <form role="form" class="was-validated">
    <div class="form-group form-group-lg row">
      ...
      <div class="col-lg-10">
        <select id="country" name="country" class="form-control selectpicker" required multiple>
      ...
      <form class="form-inline" role="search">
        ...
        <div class="input-group">
          ...
          <div class="input-group-btn">
            <button class="btn btn-dark" type="submit"><i class="glyphicon glyphicon-search"></i></button>
          </div>
        </div>
