...
var KTypeahead = function() {
    ...
    var demo1 = function() {
        ...
        $('#bp_typeahead_1, #bp_typeahead_1_modal, #bp_typeahead_1_validate, #bp_typeahead_2_validate, #bp_typeahead_3_validate').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        }, {
    ...
    var demo2 = function() {
        ...
        $('#bp_typeahead_2, #bp_typeahead_2_modal').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        },
    ...
    var demo3 = function() {
        ...
        // options being used
        $('#bp_typeahead_3, #bp_typeahead_3_modal').typeahead(null, {
            name: 'countries',
            source: countries
        });
    }
