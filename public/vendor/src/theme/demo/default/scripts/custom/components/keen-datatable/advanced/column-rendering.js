			...
			columns: [
				{
					...
					template: function(data) {
						...
						var output = '';
						if (number > 8) {
							output = '<div class="bp-user-card-v2">\
								...
								<div class="bp-user-card-v2__details">\
									<span class="bp-user-card-v2__name">' + data.first_name + '</span>\
									<a href="#" class="bp-user-card-v2__email bp-link">' +
									data.last_name + '</a>\
								</div>\
							</div>';
						}
							...
							output = '<div class="bp-user-card-v2">\
								<div class="bp-user-card-v2__pic">\
									<div class="bp-badge bp-badge--xl bp-badge--' + state + '">' + data.first_name.substring(0, 1) + '</div>\
								</div>\
								<div class="bp-user-card-v2__details">\
									<span class="bp-user-card-v2__name">' + data.first_name + '</span>\
									<a href="#" class="bp-user-card-v2__email bp-link">' +
