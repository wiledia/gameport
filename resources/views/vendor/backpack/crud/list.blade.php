      ...
      @endif
        ...
        "language": {
          ...
          @endif
			...
			// Hide tables on game overview
			table.column( ':contains(Release date)' ).visible( false );
			table.column( ':contains(Cover)' ).visible( false );
			table.column( ':contains(Giantbomb)' ).visible( false );
			table.column( ':contains(Sell)' ).visible( false );

			// The .each() method is unnecessary here:
		  table.columns( ':contains(hide)' ).every( function () {
        this.visible( false );
    	});
